...
import com.sentio.food.domain.Category;
import com.sentio.food.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.sentio.food.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
